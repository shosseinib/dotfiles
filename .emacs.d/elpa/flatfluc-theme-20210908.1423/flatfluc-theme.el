...
(defconst fui-turquoise "#27A097")
(defconst fui-emerald "#1193A4")
(defconst fui-river "#1193A4")
(defconst fui-amethyst "#6E5773")
(defconst fui-deep-asphalt "#4E4351")
(defconst fui-asphalt "#4E4351")
(defconst fui-sunflower "#FC9C76")
(defconst fui-carrot "#FC9C76")
(defconst fui-alizarin "#D87C83")
(defconst fui-clouds "#b9d5d4")
(defconst fui-concrete "#4E4351")

;; Dark colors
(defconst fui-dark-turquoise "#27A097")
(defconst fui-dark-emerald "#1193A4")
(defconst fui-dark-river "#1193A4")
(defconst fui-dark-amethyst "#6E5773")
(defconst fui-dark-asphalt "#4E4351")
(defconst fui-dark-sunflower "#D87C83")
(defconst fui-dark-carrot "#FC9C76")
(defconst fui-dark-alizarin "#D87C83")
(defconst fui-dark-clouds "#8CA7A6")
(defconst fui-deep-clouds "#627C7B")
(defconst fui-dark-concrete "#4E4351")
...
(custom-theme-set-faces
 ...
 ;; ===== basic coloring
 `(header-line ((t (:foreground ,fui-deep-asphalt :background ,fui-clouds :box (:line-width -1)))))
 ...
 `(region ((t (:background ,fui-dark-carrot :foreground ,fui-fg))))
 ...
 `(font-lock-comment-face ((t (:slant italic :foreground ,fui-deep-clouds))))
 `(font-lock-constant-face ((t (:slant italic :foreground ,fui-amethyst))))
 `(font-lock-doc-string-face ((t (:foreground "green4"))))
 `(font-lock-function-name-face ((t (:foreground ,"#C95217" :slant oblique))))
 ...
 `(font-lock-variable-name-face ((t (:foreground ,"#C95217" :slant oblique))))
 ...
 `(isearch-fail ((t (:foreground ,fui-fg :background ,fui-carrot :weight extra-bold))))
 `(lazy-highlight ((t (:foreground ,fui-fg :weight bold :background ,fui-sunflower))))

 ;; ===== Modeline
 `(mode-line ((t (:background ,fui-clouds :foreground ,fui-fg :box (:line-width 1) :family "Inconsolata-11" :height 0.8))))
 `(mode-line-buffer-id ((t (:foreground ,fui-fg))))
 `(mode-line-inactive ((t (:background ,fui-clouds :foreground ,fui-fg :box (:line-width 1) :height 0.8))))
 ...
 `(company-tooltip-common ((t (:foreground ,fui-carrot))))
 `(company-tooltip-selection ((t (:background ,fui-deep-clouds :foreground ,fui-bg))))
 `(company-tooltip-common-selection ((t (:foreground ,fui-dark-carrot :weight bold :slant italic))))
 ...
 `(helm-ff-dotted-directory ((t (:background nil :foreground ,"#C95217"))))
 ...
 `(org-todo ((t (:weight normal :foreground ,fui-river))))
 ...
 ;; ==== Message
 `(message-header-name ((t (:foreground ,fui-fg))))
 ...
 `(message-mml ((t (:foreground ,fui-fg))))
 ...
 `(notmuch-message-summary-face ((t (:foreground ,fui-fg :background ,fui-clouds))))
 ...
 `(mu4e-header-highlight-face     ((t (:background ,fui-clouds))))
 ...
 `(mu4e-url-number-face           ((t (:foreground ,fui-dark-sunflower :background ,"#84BEBD"))))
